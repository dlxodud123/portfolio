...
const Activities = () => {
    ...
    return (
        <>
            <div style={{ background: 'rgba(107, 142, 35, 0.8)', height: '1500px' }}>
                ...
                <div style={{ display: "flex", margin: "auto", width: "1280px" }}>
                    <div style={{ textAlign: 'center', width: "1280px" }}>
                        <div style={{ backgroundColor: '#ffffff', width: '1280px', height: '1000px', boxShadow: '1rem 1rem 1rem 1rem rgb(68 68 68 / 20%)', borderRadius: '30px', marginTop: "50px", paddingTop:"50px" }}>
                            <div onClick={() => {window.location.href = 'http://www.naver.com' }} className='activites_img' style={{ backgroundColor: 'white', width: '1100px', height: "150px", border: "1px solid rgba(0,0,0,0.1)", borderRadius: "15px", margin: "auto" }}>
